...
Discord のボイスチャットで使える、匿名のイエローカード／Xカードです。Cloudflare Workers または Cloudflare Pages 上で動作します。

- **△ イエローカード** — 会話の内容や進行に注意してほしいことを、匿名で知らせます
...
ボタンが押されたチャンネルに、Bot名義の注意メッセージを投稿します。VCの確認、参加者のミュート、非公開ログへの記録は行いません。
